...
$resultEmail = checkUser($pdo, $email);
        ...
        if(strLen($name) < 3) { // проверка на минимальное количество символов
        $_SESSION['nameErr'] = 'Не меньше 3 символов';
        //записываю сообщение об ошибке в сессию
        redirect('register.php');
    ...
    } elseif (strLen($password) < 3) { // проверка на минимальное количество символов
        $_SESSION['passErr'] = 'Пароль меньше 3 символов';
        //записываю сообщение об ошибке в сессию
        redirect('register.php');

    } elseif (strLen($passConfirm) < 3) { // проверка на минимальное количество символов
        $_SESSION['passErr'] = 'Пароль меньше 3 символов';
        //записываю сообщение об ошибке в сессию
        redirect('register.php');
        ...
        $values = ['name' => $name, 'email' => $email, 'password' => $passHash, 'role' => $role];
